      ...
      <div className="max-w-xl mx-auto w-full my-auto py-6">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-2xl space-y-8 text-center relative overflow-hidden">
          ...
          <div className="relative w-64 h-64 sm:w-72 sm:h-72 mx-auto flex items-center justify-center">
            ...
            {/* Loading Overlay */}
            {isLoading ? (
              <div className="absolute inset-0 z-30 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-full flex flex-col items-center justify-center space-y-3">
            ...
            {/* FIXED TOP TARGET GUIDE (Point top of device to this marker) */}
            <div className="absolute -top-4 z-20 flex flex-col items-center animate-bounce">
              <span className="text-[10px] uppercase font-black px-2 py-0.5 rounded-full bg-emerald-600 text-white shadow-md">
                Atas HP Anda
              </span>
              <div className="w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[8px] border-t-emerald-600 mt-0.5"></div>
            </div>

            {/* ROTATING COMPASS DIAL (Mata Angin N-E-S-W & Marker Kaaba Berputar Mengikuti HP) */}
            <div
